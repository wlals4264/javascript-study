...
//  - security
//  - thread safety(어플리케이션이 실행되면 프로세스 안에서 다양한 thread가 동시에 변수에 접근해서 값을 변경하는데 위험도를 줄일 수 있다)
...
// object, box container (single item들을 묶어서 한박스로 하나의 단위로 관리할 수 있게 하는 것)
...
// nubmer - speicla numeric values: infinity, -infinity, NaN (valid 값인지 확인하고 사용하기)
const infinity = 1 / 0;
